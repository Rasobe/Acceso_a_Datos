...
public class UD2_04 {
	...
	public static void main(String[] args) throws IOException {
		...
		BufferedWriter bw = new BufferedWriter(new FileWriter("ficheros/Ev1/UD02/pares.txt"));
		for (int i = 2; i < 500; i++) {
			if (i % 2 == 0) {
		...
		try {
			BufferedReader br = new BufferedReader(new FileReader("ficheros/Ev1/UD02/pares.txt"));
			String linea;
